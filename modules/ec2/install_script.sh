...
sudo echo ${var.db_password} | sudo tee /root/db_password.txt > /dev/null
sudo echo ${var.db_user} | sudo tee /root/db_username.txt > /dev/null
sudo echo ${var.rds_endpoint} | sudo tee /root/db_endpoint.txt > /dev/null
